...
export interface GameState {
  ...
  pointsAwarded?: boolean // Nueva propiedad para rastrear si se otorgaron puntos
  dailyChallenges: ClubChallenge[] // AÑADIDO: Para persistir la secuencia de desafíos
  date: string // AÑADIDO: Para saber de qué día es el estado guardado
}
